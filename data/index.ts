...
export const gridItems = [
  ...
  {
    id: 2,
    title: "I'm Open to Remote Work with Companies Worldwide",
    description: "",
  ...
  },
  {
    id: 4,
    title:
      "Creative and Logical Problem Solver with a Passion for Development.",
    description: "",
...

  {
    id: 5,
    title:
      "Currently Building a React Native App for Supporting People Relocating Internationally.",
